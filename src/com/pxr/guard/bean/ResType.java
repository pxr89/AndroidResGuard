...
public class ResType {
	/**
	 * 资源文件中的定义的 xml，table类型
	 * 
	 * @author panxianrong
	 *
	 */
	public static final short RES_NULL_TYPE = 0x0000;
	public static final short RES_STRING_POOL_TYPE = 0x0001; // ResStringPool
	...
	public static final short RES_TABLE_PACKAGE_TYPE = 0x0200; // ResTablePackage,
																// 通常只有一个啊
	public static final short RES_TABLE_TYPE_TYPE = 0x0201; // ResTableType
	public static final short RES_TABLE_TYPE_SPEC_TYPE = 0x0202; // ResTableTypeSpec

	public static String getStrType(short type) {
		switch (type) {
		case RES_NULL_TYPE:
		...
		case RES_XML_START_NAMESPACE_TYPE:
			return "RES_XML_FIRST_CHUNK_TYPE | RES_XML_START_NAMESPACE_TYPE";
